...
const DB_HOST = "testappmern.z1dtnpd.mongodb.net";
const JWT_SECRET_KEY = 'oiuer4568dfgkjw589fjgkw4985jkfg';

const API_VERSION = "v1";
const IP_SERVER = "127.0.0.1";
// const DB_CONNECT = `mongodb+srv://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/?retryWrites=true&w=majority` // vieja
// const DB_CONNECT = `mongodb+srv://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/`; // nueva
